...

{
  ...
  sops = {
    defaultSopsFile = ../../secrets/seed-dfw-2.yaml;
  ...
  seed = {
    ...
    k3s.dualStack = true;
    k3s.extraFlags = [
      "--node-ip=104.238.146.15,2001:19f0:6401:2a5:3eec:efff:feb9:8888"
    ];
  };
  ...
  networking = {
    ...
    interfaces.enp1s0f0 = {
      useDHCP = true;
      ipv6.addresses = [
        { address = "2001:19f0:6401:2a5:3eec:efff:feb9:8888"; prefixLength = 64; }
      ];
    };
    defaultGateway6 = {
