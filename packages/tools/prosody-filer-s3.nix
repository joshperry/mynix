...
buildGoModule {
  pname = "prosody-filer-s3";
  version = "unstable-2020-11-10";

  src = fetchFromGitHub {
    owner = "Wilm0r";
    repo = "prosody-filer-s3";
    rev = "bbbdcd650c0cddc1ae129158597e053275e5fee0";
    hash = "sha256-oGymax/lO1wW0CKHuIZDHUqPby6xch6lSBs8kEW03tI=";
  };

  postPatch = ''
    # Rewrite imports from pre-modules path to v7 module path
...
EOF
  ...
  vendorHash = "sha256-Honv4y0AFLubrH5hVStJxLwobkv4NAr8mc+B1diyUm4=";

  doCheck = false;

  meta = with lib; {
    description = "Prosody HTTP upload handler with S3 backend";
    homepage = "https://github.com/Wilm0r/prosody-filer-s3";
    license = licenses.mit;
    mainProgram = "prosody-filer-s3";
  };
}
